...
public final class MediaFormat implements Parcelable {
  ...
  /* package */ MediaFormat(Parcel in) {
	...
	Log.i("mediaformat", "mediaformat panpan test, in MediaFormat, durationUs = " + durationUs);
    width = in.readInt();
    height = in.readInt();
  ...
  /* package */ MediaFormat(String trackId, String mimeType, int bitrate, int maxInputSize,
	...
	Log.i("mediaformat", "mediaformat panpan test, in MediaFormat 2, durationUs = " + durationUs);
	Exception e = new Exception("MediaFormat panpan test, durationUs.");
	e.printStackTrace();
    this.width = width;
    this.height = height;
